...
as well as the SageMath (documentation build) source code, in particular the
...
project = "Numerical computation of Riemann theta functions"
copyright = "2021, Nils Bruin"
package_name = "riemann_theta"
package_folder = "../.."
authors = "Nils Bruin, Sohrab Ganjian"
